...
DEFINE_int32(chassis_pending_queue_size, 50, "Max chassis pending queue size");
DEFINE_int32(localization_pending_queue_size, 50,
             "Max localization pending queue size");
DEFINE_int32(prediction_pending_queue_size, 10,
             "Max prediction pending queue size");
//emergency light add
DEFINE_double(min_stop_speed, 0.5,"the min speed that adc stop ");
DEFINE_double(min_stop_distance, 0.5,"the min distance when adc_stop");
DEFINE_double(emergency_delay_time, 10.0,"triggle emergency_light delay time");
...
DEFINE_double(pull_over_offset, 0,
              "The offset of pull-over");
...
DEFINE_double(reverse_yield_distance, 5.0,    
              "min yield distance for reverse driving vehicles/moving objects ");
