...
DECLARE_int32(prediction_pending_queue_size);

//emergency light add
DECLARE_double(min_stop_speed);
DECLARE_double(min_stop_distance);
DECLARE_double(emergency_delay_time);
// scenarios related
...
DECLARE_double(pull_over_offset);
...
DECLARE_double(reverse_yield_distance);
