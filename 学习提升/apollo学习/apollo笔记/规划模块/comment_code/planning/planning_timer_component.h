...
class PlanningTimerComponent final : public apollo::cyber::TimerComponent {
 public:
  PlanningTimerComponent() = default;
 ...
 private:
  void OnPrediction(const std::shared_ptr<apollo::prediction::PredictionObstacles> &prediction);
 ...
 private:
  ...
  std::shared_ptr<cyber::Reader<prediction::PredictionObstacles>> prediction_reader_;
...
CYBER_REGISTER_COMPONENT(PlanningTimerComponent)
