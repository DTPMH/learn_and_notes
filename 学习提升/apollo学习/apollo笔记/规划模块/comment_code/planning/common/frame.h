...
// void get_pathboundary(planning_internal::Debug* debug_chart);
 //std::list<ReferenceLineInfo> dt_reference_line_info_;
  ...
  // const std::list<ReferenceLineInfo> get_reference_line_info() const;
